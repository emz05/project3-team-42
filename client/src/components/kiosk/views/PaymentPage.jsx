...
export default function PaymentPage() {
  ...
  usePageSpeech(
    `Payment screen. Your total is ${formattedTotal}. Enter your card details, then choose Pay Now to complete your order or go back to review.`
  );
        ...
        <div className="payment-container">
          ...
          <form onSubmit={handleSubmit} className="payment-form">
            ...
            <div className="button-group">
              <SpeakOnHover text="Back to review">
                <button
                  type="button"
